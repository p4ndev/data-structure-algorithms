...
namespace Problems
{
    public class LC1768MergeStrings
    {
        /*
...
/*
Quem bateu o máximo de eficiência não foi até o final do LOOP, fez um substring após o menor concluir o merge do menor (menos execuções). 
*/